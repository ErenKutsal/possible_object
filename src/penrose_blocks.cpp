...
static void bg_init()
{
    bg_program  = InitShader(SHADER_DIR "core/vshader_halo.glsl", SHADER_DIR "backgrounds/fshader_clockwork_bg.glsl");
...
{
    g_shape.init(SHADER_DIR"../models/penrose_stair.obj", obsidian_palette(), nullptr, SHADER_DIR "objects/fshader_kintsugi.glsl");
