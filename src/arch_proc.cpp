...
{
    halo_program = InitShader(SHADER_DIR"core/vshader_halo.glsl", SHADER_DIR "core/fshader_halo.glsl");
...
void archp_init()
{
    g_shape.init("../models/impossible_arch_curved.obj", arch_proc_palette(),
        SHADER_DIR"objects/vshader_iridescent.glsl",
        SHADER_DIR"objects/fshader_iridescent.glsl");
    ...
    sky_program  = InitShader(SHADER_DIR"backgrounds/vshader_skybox.glsl",
                              SHADER_DIR"backgrounds/fshader_skybox.glsl");
