...
static void bg_init()
{
    ...
    bg_program = InitShader(SHADER_DIR "core/vshader_halo.glsl", SHADER_DIR "backgrounds/fshader_earth_background.glsl");
...
void cube_init()
{
    ...
    g_shape.init(SHADER_DIR"../models/impossible_cube.obj", earth_palette(), nullptr, SHADER_DIR "objects/fshader_earth.glsl");
