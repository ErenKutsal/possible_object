...
void main()
{
    // FLAT ILLUSION MODE — show only the solid per-face orientation color
    // (the classic impossible-figure look), bypassing all texture, lighting,
    // edges, gradient and animation.
    if (uFlatShade == 1) {
